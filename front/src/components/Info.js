...
class Info extends React.Component {
    render() {
        return <div>
            ...
            <p>Vous pouvez dès maintenant télécharger un fichier via n'importe quel torrent. N'oubliez pas de changer la localication de destination pour le fichier. Prenez le dossier précédemment créé, par exemple <i>/media/usb0/films</i> s'il s'agit d'un film.</p>
